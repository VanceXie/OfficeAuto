...
class BingImagesSpider:
	...
	def request_and_save_image(self, info):
		...
		filename = '{} {}.{}'.format(self.count,os.path.basename(info['image_url']), info['image_type'])
...
if __name__ == '__main__':
	# 关键词：工业场景 条码标签
	# 需要的图片数量：100
	# 图片保存路径：'D:\Fenkx\Fenkx - General\AI\Dataset\01'
	start = time()
	BingImagesSpider('工业条码标签', 300, r'D:\Fenkx\Fenkx - General\AI\Dataset\01').run()
	print(time() - start)
